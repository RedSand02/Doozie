...
export interface IScans extends IProps {
}
...
function TabPanel(props: ITabPanel) {
    ...
    return (
        <Typography
            ...
            role="tabpanel"
            hidden={value !== index}
            id={`full-width-tabpanel-scans-${index}`}
            aria-labelledby={`full-width-tab-scans-${index}`}
            {...other}
        >
...
function a11yProps(index: number) {
    return {
        id: `full-width-tab-scans-${index}`,
        'aria-controls': `full-width-tabpanel-scans-${index}`,
    };
}
...
export default function Scans(props: IScans) {
